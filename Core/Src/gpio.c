...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOB, AIN2_Pin|AIN1_Pin|BIN1_Pin|BIN2_Pin);
  ...
  /**/
  LL_GPIO_SetPinPull(Bamper_GPIO_Port, Bamper_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(Bamper_GPIO_Port, Bamper_Pin, LL_GPIO_MODE_INPUT);
